...
import com.kangaroo.simpleinterceptor.internal.tools.JsonConvertor;
...
public class HttpTransaction {
    ...
    public String getRequestDateString() {
        ...
        return (requestDate != null) ? df4.format(requestDate) : null;
    }

    public String getResponseDateString() {
        DateFormat df4 = DateFormat.getDateTimeInstance(DateFormat.LONG , DateFormat.LONG );
        return (responseDate != null) ? df4.format(responseDate) : null;
    }
