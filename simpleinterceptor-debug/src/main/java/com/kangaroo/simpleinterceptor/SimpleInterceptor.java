...
public final class SimpleInterceptor implements Interceptor {
     ...
     * @return The {@link SimpleInterceptor} instance.
     */
    public SimpleInterceptor showNotification(boolean show) {
     ...
     * @return The {@link SimpleInterceptor} instance.
     */
    public SimpleInterceptor maxContentLength(long max) {
     ...
     * @return The {@link SimpleInterceptor} instance.
     */
    public SimpleInterceptor retainDataFor(Period period) {
    ...
    private Uri create(HttpTransaction transaction) {
        ...
        Uri uri = context.getContentResolver().insert(InterceptorContentProvider.TRANSACTION_URI, values);
